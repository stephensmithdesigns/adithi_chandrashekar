...
class VP_ShortcodeGenerator
{
	...
	function print_form($attributes)
	{
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php esc_attr_e('Insert', 'massive-dynamic'); ?></button>
			<button class="vp-sc-cancel button"><?php esc_attr_e('Cancel', 'massive-dynamic') ?></button>
		</div>
		<?php
	}
