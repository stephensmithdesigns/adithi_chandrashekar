...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        ...
        <tr>
            ...
            <th class="product-name"><?php esc_attr_e('Product', 'massive-dynamic'); ?></th>
            <th class="product-price"><?php esc_attr_e('Price', 'massive-dynamic'); ?></th>
            <th class="product-quantity"><?php esc_attr_e('Quantity', 'massive-dynamic'); ?></th>
            <th class="product-subtotal"><?php esc_attr_e('Total', 'massive-dynamic'); ?></th>
            <th class="product-remove"><?php esc_attr_e('Del', 'massive-dynamic'); ?></th>
        </tr>
        </thead>
        <tbody>
                ...
                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                    ...
                    <td class="product-name" data-title="<?php _e( 'Product', 'massive-dynamic' ); ?>">
                        ...
                        if ($_product->backorders_require_notification() && $_product->is_on_backorder($cart_item['quantity'])) {
                            echo '<p class="backorder_notification">' . esc_html__('Available on backorder', 'massive-dynamic') . '</p>';
                        }
                        ?>
                    </td>
