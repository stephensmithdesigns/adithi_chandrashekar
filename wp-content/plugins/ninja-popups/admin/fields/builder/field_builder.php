    ...
    function element_tpl_editbox($type, $args = array(), $RAND)
	{
        ...
        <div class="bld-el-editbox bld-el-editbox-<?php echo $type ;?>" id="editbox-element-<?php echo $RAND ;?>" data-id="element-<?php echo $RAND ;?>">
			...
			<div class="bld-form-group">
                        ...
                        if(in_array($type, array('button','input','calendar','hidden','textarea','select','radio','checkbox'))):  ?>
                            ...
                            <?php if (in_array($type, array('button','input','calendar','hidden','textarea','select','radio','checkbox'))):  ?>
                            	<div class="bld-form-group">
		...
		class="<?php if($RAND=='RAND') {echo 'bld-el-cont-tpl';}?> bld-el-cont bld-el-<?php echo $type; ?> <?php echo $cont_css_class;?>" <?php echo $cont_data; ?> id="element-<?php echo $RAND ;?>">
            ...
            if ($type == 'text') {
                ...
                if (!snp_get_option('js_disable_recaptcha')) {
                    wp_enqueue_script('js-recaptcha-api', 'https://www.google.com/recaptcha/api.js?onload=CaptchaCallback&render=explicit');
                }
                
                echo '<div class="g-recaptcha" data-sitekey="' . snp_get_option('recaptcha_api_key') . '"></div>';

                echo '<script type="text/javascript">
                    var CaptchaCallback = function() {
                        jQuery(\'.g-recaptcha\').each(function(index, el) {
                            grecaptcha.render(el, {
                                \'sitekey\' : \''.snp_get_option('recaptcha_api_key').'\'
                            });
                        });
                    };
                </script>';
