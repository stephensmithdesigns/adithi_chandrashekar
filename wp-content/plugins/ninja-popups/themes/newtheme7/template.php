	...
	<div class="snp-steps snp-step-1 snp-step-show">
        ...
        <footer class="snp-theme__footer snp-flush--top">
        	<div class="snp-theme__choice">
				...
				echo '</a>';
				if (
					!isset($POPUP_META['snp_s1disable_right']) ||
					$POPUP_META['snp_s1disable_right'] != 2
				) {
...
if (!empty($POPUP_META['snp_bg_color1'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 { background: '.format_hex($POPUP_META['snp_bg_color1']).';}'."\n";
}

if (!empty($POPUP_META['snp_bg_color2'])) {
	echo '.snp-pop-'.$ID.' .snp-theme__footer { background: '.format_hex($POPUP_META['snp_bg_color2']).';}'."\n";
}

if (!empty($POPUP_META['snp_footer_border_top'])) {
	echo '.snp-pop-'.$ID.' .snp-theme__footer { border-top: 1px solid '.format_hex($POPUP_META['snp_footer_border_top']).';}'."\n";
}

if (!empty($POPUP_META['snp_s1header_font']['size'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 {color: '.format_hex($POPUP_META['snp_s1header_font']['color']).';}';
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-h3 {font-size: '.$POPUP_META['snp_s1header_font']['size'].'px; color: '.format_hex($POPUP_META['snp_s1header_font']['color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s1subheader_font']['size'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-h1{ font-size: '.$POPUP_META['snp_s1subheader_font']['size'].'px; color: '.format_hex($POPUP_META['snp_s1subheader_font']['color']).';}'."\n";
...
if (!empty($POPUP_META['snp_s1left_button_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-btn--primary { background: '.format_hex($POPUP_META['snp_s1left_button_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s1left_button_text_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-btn--primary { color: '.format_hex($POPUP_META['snp_s1left_button_text_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s1right_button_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-btn--secondary { background: '.format_hex($POPUP_META['snp_s1right_button_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s1right_button_text_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-1 .snp-btn--secondary { color: '.format_hex($POPUP_META['snp_s1right_button_text_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s2header_font']['size'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-2 .snp-h3 {font-size: '.$POPUP_META['snp_s2header_font']['size'].'px; color: '.format_hex($POPUP_META['snp_s2header_font']['color']).';}'."\n";
}

if (!empty($POPUP_META['snp_submit_button_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-2 .snp-btn--primary { background: '.format_hex($POPUP_META['snp_submit_button_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_submit_button_text_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-2 .snp-btn--primary { color: '.format_hex($POPUP_META['snp_submit_button_text_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s3button_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-3 .snp-btn--secondary { background: '.format_hex($POPUP_META['snp_s3button_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s3button_text_color'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-3 .snp-btn--secondary { color: '.format_hex($POPUP_META['snp_s3button_text_color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s3header_font']['size'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-3 .snp-h2 {font-size: '.$POPUP_META['snp_s3header_font']['size'].'px; color: '.format_hex($POPUP_META['snp_s3header_font']['color']).';}'."\n";
}

if (!empty($POPUP_META['snp_s3subheader_font']['size'])) {
	echo '.snp-pop-'.$ID.' .snp-newtheme7 .snp-step-3 .snp-h1 { font-size: '.$POPUP_META['snp_s3subheader_font']['size'].'px; color: '.format_hex($POPUP_META['snp_s3subheader_font']['color']).';}'."\n";
}
echo '</style>';
